...
Snake game program written in RISC-V and assembled to hex, simulated in Logism Evolution:

https://github.com/user-attachments/assets/abbb8b1b-15d1-4978-b6de-d2f52b5f29e0

TTY example written in RISC-V and assembled to hex (uses MMIO polling), simulated in Logism Evolution:

https://github.com/user-attachments/assets/4bbf83e8-264e-4881-8599-f2da4b0f7e07

Picture of the CPU in Logism Evolution:
...
Picture of the GPU in Logism Evolution:
